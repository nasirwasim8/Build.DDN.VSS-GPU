...
class S3Handler:
    ...
    def create_client(self) -> bool:
        ...
        try:
            ...
            if self.config_type == 'ddn_infinia':
                # request_checksum_calculation='when_required' prevents newer botocore
                # from sending chunked Transfer-Encoding which INFINIA doesn't support.
                boto_config = Config(
    ...
    def _get_last_error(self) -> str:
        ...
        return getattr(self, '_last_error', 'Unknown error during client creation')
    ...
    def test_connection(self) -> Tuple[bool, str]:
        ...
        if not self._ensure_client():
            error_detail = self._get_last_error()
            return False, f"Failed to create S3 client: {error_detail}"
